...
function getAverageWordLength(arr) {
  ...
  averageWords = totalWords / arr.length;
  return averageWords;
}
...
function getRandomFlavors(arrOne, arrTwo, arrThree, arrFour) {
  let randomFlavors = [];
  let arrOneRand = Math.floor(Math.random() * arrOne.length);
  let arrTwoRand = Math.floor(Math.random() * arrTwo.length);
  let arrThreeRand = Math.floor(Math.random() * arrThree.length);
  let arrFourRand = Math.floor(Math.random() * arrFour.length);

  randomFlavors.push(
    arrOne[arrOneRand],
    arrTwo[arrTwoRand],
    arrThree[arrThreeRand],
    arrFour[arrFourRand]
  );
